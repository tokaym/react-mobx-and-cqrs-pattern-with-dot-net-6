...
public class Zm20 : Entity
{
    ...
    public Zm20(Guid id, string? materialSat, string? star, string? uY, string? uYCode, string? dY, DateTime releaseDate, DateTime arrivalDate, string? materialSKU, string? materialName, string? unit, int amountDelivered, int openAmount,
    ...
    string? empty5, string? seller, string? sellerName, string? empty6, string? empty7, string? empty8, string? contractNo, string? empty9, string? item2) : base(id)
    {
        Id = id;

...
public class Zs14History : Entity
{
    ...
    public Zs14History(Guid id, string star, DateTime instantDate, string tYeri, string materialSKU, string mipArea,string materialName, string empty1, string definition, int hfOrder,
    ...
    int teslpln, int consumptionValue, int transportStock, DateTime createdTime, Guid userId) : base(id)
    {
        Id = id;
        Star = star;

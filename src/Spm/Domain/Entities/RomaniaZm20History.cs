...
public class RomaniaZm20History : Entity
{
    ...
    public RomaniaZm20History()
    {
    }

    public RomaniaZm20History(Guid id, string? materialSat, int? item, string? trmSt, string? stBu, string? salesInf, int? item2, string saRequest,
    ...
    string? star, string? tahKlm, string? seller, string? ad11, string? alternative, string? sasItem, DateTime createdTime, DateTime reportDate, Guid userId) : base(id)
    {
        Id = id;
